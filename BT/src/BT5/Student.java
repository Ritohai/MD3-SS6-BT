...
public class Student {
    ...
    public Student(int idStudent, String nameStudent, int age, boolean sex, String address, String phoneNumber) {
    ...
    public Student inputData() {
        ...
        Student s = new Student(idStudent, nameStudent, age, sex, address, phoneNumber);
        return s;
    }
