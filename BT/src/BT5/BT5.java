...
public class BT5 {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            System.out.println("--------------------------------");
            System.out.println("Xây dựng menu chức năng bao gồm :\n" +
    ...
    public static void showStudent(Student[] studentsr) {
        boolean check = false;
    ...
    public static void updateStudent(Student[] students) {
        ...
        for (int i = 0; i < students.length; i++) {
            if ((students[i].getIdStudent()) == id) {
                ...
                Student st = new Student(id, nameStudent, age, sex, address, phoneNumber);
                students[i] = st;
